    ...
    this.backendSteps = [
      {
        ...
        topics: [
          'Java Basics & Core Foundations',
          'Object-Oriented Programming (OOP)',
          'Java Advanced OOP & Modern Features',
          'Exception Handling & Best Practices',
          'Collections Framework',
          'Generics + Functional Interfaces + Lambda',
          'Streams API + Functional Programming',
          'Multithreading & Concurrency',
          'Virtual Threads (Java 21) & Modern Concurrency',
          'Java Ecosystem, JVM Internals & Best Practices',
        ],
        tutorials: [],
        isActive: true,
        isCompleted: false,
